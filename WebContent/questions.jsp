...
<!-- SIDEBAR -->
            ...
            <div class="content-area" >
                            <div class="panel form-style-6" style="min-width: 200px;max-width: 290px;float: left">
        ...
        <div class="panel form-style-6" style="padding-right:300px;margin-left:-200px; float: right;">   
